...
pairwise.wilcox.test(dataset$rating, dataset$effectiveness, p.adjust.method = "BH")
```
...
Next, a chi-squared test is used to further examine if effectiveness is independent of as the rating changes at 0.05 significance level. Here, the hypothesis is:
